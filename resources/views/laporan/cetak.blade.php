...
<body class="bg-gray-100 min-h-screen">
    ...
    <div class="no-print fixed top-0 left-0 w-full bg-gray-800 p-2 flex justify-between shadow-lg">
    ...
    <div class="bg-white max-w-4xl mx-auto mt-20 mb-10 p-10 shadow-xl border print:shadow-none print:border-none print:m-0 print:w-full">
        ...
        <div class="text-center border-b-4 border-double border-black pb-4 mb-6">
            ...
            <p class="text-sm text-gray-600">Jl. Raya Banyakan No. 123, Jawa Timur | Telp: 0812-3456-7890</p>
            <p class="text-sm text-gray-600">Toko Sparepart Motor & Aksesoris</p>
        </div>

        <!-- keluar atau masuk dan waktu -->
        ...
        <table class="w-full border-collapse border border-black text-sm">
            ...
            <tfoot>
                <tr class="font-bold bg-gray-100">
                    <td colspan="4" class="border border-black p-2 text-right text-lg">TOTAL</td>
